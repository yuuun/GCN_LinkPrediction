...
### Evaulation Protocol: NDCG and Recall
### This is the code from https://github.com/LunaBlack/KGAT-pytorch/utils/metrics.py
### Since the dataset is too large, we cannot reconstruct the adjacency matrix
